...
function App() {
  ...
  return (
    <main
      className={`cyberpunk-root cyberpunk-bg relative flex h-[310px] w-80 flex-col overflow-hidden px-4 py-4 text-[var(--text-primary)] shadow-[0_22px_50px_rgba(var(--accent-rgb),0.24)] ${themeClass}`}
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-[10px] tracking-[0.32em] text-[var(--text-muted)] uppercase">
            <span className="h-1.5 w-1.5 rounded-full bg-[var(--accent-200)] shadow-[0_0_6px_rgba(var(--accent-rgb),0.8)]" />
            Tomato
          </div>
          <button
            type="button"
            ...
            className="rounded-md border border-[color:rgba(var(--accent-rgb),0.4)] bg-[rgba(var(--panel-rgb),0.7)] p-2 text-[var(--text-soft)] transition hover:bg-[rgb(var(--panel-strong-rgb))] hover:shadow-[0_0_12px_rgba(var(--accent-rgb),0.35)]"
          >
          ...
          >
            ...
            >
              ...
              <div className="mt-auto grid gap-3">
                <button
                  className="group neon-primary relative overflow-hidden rounded-xl px-3 py-2 font-semibold text-[rgb(var(--panel-strong-rgb))] transition hover:-translate-y-0.5 hover:shadow-[0_14px_26px_rgba(var(--accent-rgb),0.35)]"
                ...
                <button
                  className="group neon-secondary relative overflow-hidden rounded-xl px-3 py-2 font-semibold text-[var(--text-soft-strong)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_22px_rgba(var(--accent-rgb),0.2)] disabled:cursor-not-allowed disabled:opacity-50"
            ...
            >
              <div className="text-[10px] tracking-[0.32em] text-[var(--text-subtle)] uppercase">
                Settings
              </div>
              <div className="fancy-scrollbar flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto pr-2">
                <div className="grid gap-1.5">
                  <label
                    htmlFor="workMinutes"
                    className="text-[10px] tracking-[0.18em] text-[var(--text-subtle-muted)] uppercase"
                  >
                    Work minutes
                  </label>
                  <input
                    ...
                    className="neon-input w-full rounded-lg px-3 py-1.5 text-xs text-[var(--text-primary)] focus-visible:ring-2 focus-visible:ring-[rgba(var(--accent-rgb),0.6)] focus-visible:outline-none"
                  />
                </div>
                <div className="grid gap-1.5">
                  <label
                ...
                <div className="flex items-center justify-between gap-3 text-xs text-[var(--text-soft)]">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="rounded-md border border-[color:rgba(var(--accent-rgb),0.4)] bg-[rgba(var(--panel-rgb),0.7)] p-1.5 text-[var(--text-soft)] transition hover:bg-[rgb(var(--panel-strong-rgb))] hover:shadow-[0_0_10px_rgba(var(--accent-rgb),0.3)]"
                  ...
                  <span className="relative inline-flex items-center">
                    ...
                    <span className="absolute top-0.5 left-0.5 h-3 w-3 rounded-full bg-[var(--toggle-knob)] transition peer-checked:translate-x-4 peer-checked:bg-[var(--toggle-knob-active)]" />
                  </span>
                </div>
              </div>

              <button
                className="neon-secondary rounded-xl px-3 py-1.5 text-xs font-semibold text-[var(--text-soft-strong)] transition hover:shadow-[0_0_16px_rgba(var(--accent-rgb),0.25)]"
